...
import { Header, BackButton, Modal } from '../../components';
...
const Launches: React.FC = () => {
    ...
    const filteredLaunches = useMemo(() => {
        ...
        return launches.filter(
            ({ mission_name, launch_date_local, rocket }) => {
                if (
                    search &&
    ...
    const handleOpenModal = useCallback((links: Links) => {
